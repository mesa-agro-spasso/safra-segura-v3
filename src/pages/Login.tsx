    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md border-border">
        <CardHeader className="text-center">
          <img src="/logo-spasso.png" alt="Grupo Spasso" className="w-48 mx-auto mb-2 block dark:hidden" />
          <img src="/logo-spasso-dark.png" alt="Grupo Spasso" className="w-48 mx-auto mb-2 hidden dark:block" />
